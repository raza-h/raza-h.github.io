...
export default function About() {
  return (
    <section className={`text-[#cac7bd] md:text-[#5a5959] grid md:grid-cols-2 border-2 border-[#cac7bd] md:border-0 w-[90%] sm:w-[80%] md:w-[90%] lg:w-[80%] xl:w-[70%] ml-auto mr-auto rounded-sm`}>
